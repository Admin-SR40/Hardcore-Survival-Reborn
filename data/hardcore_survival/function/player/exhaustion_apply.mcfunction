attribute @s movement_speed modifier add exhaustion.movement_speed -0.3 add_multiplied_total
attribute @s jump_strength modifier add exhaustion.jump_strength -0.1 add_multiplied_total
